...
var Query = React.createClass(
{
  ...
  _handleStartYearChange: function(
    e)
  {
    this.setState(
    {
  ...
  render: function()
  {
    return (
      ...
      <
      div className =
      "form-group col-md-offset-3 col-md-6" >
      <
      label htmlFor = "topic"
      ...
      button type = "submit"
      className =
      "btn btn-info col-md-offset-5 col-md-2"
      id = "searchBtn" > Search <
      /button>
      <
      /form> <
