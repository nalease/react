...
var Main = React.createClass({
  ...
  _setSearchFeilds: function(topic,
    start, end) {
    this.setState({
      searchTerms: [topic,
        start, end
  ...
  componentDidUpdate: function(
    ...
    if (this.state.searchTerms !=
      ...
      helpers.articleQuery(this.state
        .searchTerms[0], this.state
        .searchTerms[1], this.state
        .searchTerms[2]).then(
        function(data) {
          //console.log(data);
          this.setState({
  ...
  render: function() {
    return ( < div className = "panel panel-default"
      ...
      <
      h1 className =
      "text-center" > < img style = {
        {
          width: "70%"
        }
      }
      src = "img/nyt-header.png"
      alt =
      "The New York Times" / >
      <
      /h1> <
      ...
      } > < b > < i > A React Rendition <
      /i></b > < /h2> <
      h4 className =
      "text-center" > Search
      for and annotate articles of
      interest.Click on headlines to learn more
      . < /h4> < /
      div >
      <
      Query _setSearchFeilds = {
        this._setSearchFeilds
      }
      /> <
      Search apiResults = {
      ...
      _resetMongoResults = {
        this._resetMongoResults
      }
      /> <
      Saved mongoResults = {
        this.state.mongoResults
      }
      _resetMongoResults = {
        this._resetMongoResults
      }
